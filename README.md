...
- quotes 对基金（ETF）价格精度为 0.001 元 → 返回价 ×10（510300 实际 4.523 会显示 45.23，pytdx 同款行为）；基金行情请用 snap/bars（float32 直读，精度正确）
- 市场自动判断规则：5/6/9 开头=沪（5 基金/6 A/9 B），0/1/2/3 开头=深（0 A/1 基金/2 B/3 创业板）；北交所(4/8/92)暂不支持
